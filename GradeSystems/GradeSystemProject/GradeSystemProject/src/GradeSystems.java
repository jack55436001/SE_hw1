...
public class GradeSystems {
    ...
    *
	* Time estimate : O (n)
	* Example: gs.showGrade(103062319) 螢幕顯示各項成績
	----------------------------------------------------------------------------------------------------------*/
    ...
    *
	* Time estimate : O (n)
	* Example: gs.showRnak(103062319) 螢幕顯示該學號之排名
	----------------------------------------------------------------------------------------------------------*/
    ...
    *
	* Time estimate : O (n)
	* Example: gs.containsID(103062319) 回傳false
	----------------------------------------------------------------------------------------------------------*/
    ...
    *
	* Time estimate : O (n)
	* Example: gs.updateWeights([20,20,20,20,20]) 將各項成績比重更新為20%
	----------------------------------------------------------------------------------------------------------*/
	public void updateWeights (int [] getNewWeight){
		...
		try{
			...
			if(sum != 100)	throw new ReweightException(1,-1);
    ...
    *
	* Time estimate : O (1)
	* Example: gs.showOldWeights() 顯示當前權重
	----------------------------------------------------------------------------------------------------------*/
	...
	*	
	*Pseudo code:
	*1.利用迴圈尋找系統中該學號對應的名字並回傳
    *
	* Time estimate : O (n)
	* Example: gs.findNameByID(103062319) 回傳JSharp
	----------------------------------------------------------------------------------------------------------*/
	...
	*Pseudo code:
	*1.利用迴圈加總各項成績
	*2.各項成績總和除以人數取得平均並顯示至螢幕
    *
	* Time estimate : O (n)
	* Example: gs.showAverage() 螢幕顯示各項成績之平均
	----------------------------------------------------------------------------------------------------------*/
