...
public class UITest {
	...
	* Example:UITest.testShowWelcomeMsg2()  測試testShowWelcomeMsg2
	...
	/* method  testPromptCommand1----------------------------------------------------------------------------------                                                                                                    
	* 測試promptCommand(955002056)輸入Ｇ後輸入Ｅ是否正常
	*
	* @param 無
	* @return 無
	*
	...
	*	
	*Pseudo code:
	*1.利用System.setIn()預先輸入input G\nE
	*2.測試ui.promptCommand(955002056)輸入input後回傳值是否為true
    *
	* Time estimate : O (1)
	* Example:UITest.testPromptCommand1()  測試testPromptCommand1
	----------------------------------------------------------------------------------------------------------*/
	@Test
	...
	/* method  testPromptCommand2----------------------------------------------------------------------------------                                                                                                    
	* 測試promptCommand(962001051)輸入E是否正常
	*
	* @param 無
	* @return 無
	*
	...
	*	
	*Pseudo code:
	*1.利用System.setIn()預先輸入input E
	*2.測試ui.promptCommand(962001051)輸入input後回傳值是否為false
    *
	* Time estimate : O (1)
	* Example:UITest.testPromptCommand2()  測試testPromptCommand2
	----------------------------------------------------------------------------------------------------------*/
	@Test
	...
	*	
	*Pseudo code:
	*1.利用System.setIn()預先輸入input Q
	*2.測試ui.login()輸入input後回傳值是否為-1
    *
	* Time estimate : O (1)
	* Example:UITest.testLogin1()  測試testLogin1
	----------------------------------------------------------------------------------------------------------*/
	@Test
	...
	*	
	*Pseudo code:
	*1.利用System.setIn()預先輸入input 962001051
	*2.測試ui.login()輸入input後回傳值是否為962001051
    *
	* Time estimate : O (1)
	* Example:UITest.testLogin2()  測試testLogin2
	----------------------------------------------------------------------------------------------------------*/
	@Test
